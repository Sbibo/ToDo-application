...
describe('controller', function () {
	...
	describe('toggle all', function () {
		it('should toggle all todos to completed', function () {
			// TODO: write test
			var todo ={title: 'my todo', completed:false,id:12,}
			setUpModel([todo]);
			subject.setView('');
			view.trigger('toggleAll',{completed:true})
			expect(model.update).toHaveBeenCalledWith(12, {completed: true}, jasmine.any(Function));
		});
	...
	describe('new todo', function () {
		it('should add a new todo to the model', function () {
			...
			subject.setView('');
			view.trigger('newTodo','todo a faire')
			expect(model.create).toHaveBeenCalledWith('todo a faire', jasmine.any(Function));
		});
